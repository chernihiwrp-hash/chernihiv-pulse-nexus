...
import { AlertTriangle, Shield, Swords, Scale, Gavel, Flame, Crosshair, Skull, Target, Eye, BookOpen, ShieldCheck, ChevronRight, Users } from "lucide-react";
...
const Factions = () => {
  ...
  useEffect(() => {
    // Рахуємо схвалені заявки по кожній фракції
    supabase
      ...
      .then(({ data }) => {
        ...
        data.forEach(row => {
          const id = row.faction_id as string;
        ...
        >
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <div className="flex items-center gap-1 px-2 py-1 rounded-lg"
              ...
              <span className="text-[10px] font-semibold" style={{ color: f.color }}>{count}</span>
            </div>
